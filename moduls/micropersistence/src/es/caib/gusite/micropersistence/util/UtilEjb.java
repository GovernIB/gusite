...
public class UtilEjb {
	...
	public static InitialContext getInitialContext(String jndi, boolean local,
		...
		environment.put(Context.INITIAL_CONTEXT_FACTORY,
				getInitialContextFactory(url));
		environment.put(Context.URL_PKG_PREFIXES, URL_PKG_PREFIXES);
		initialContext = new javax.naming.InitialContext(environment);
		return initialContext;
	}

	public static Object lookupHome(String jndi, boolean local, String url,
	...
	private static String getInitialContextFactory(String url) {
		return url.startsWith(HTTP_PROTOCOL) ? HTTP_INITIAL_CONTEXT_FACTORY
				: JNP_INITIAL_CONTEXT_FACTORY;
	}
}
