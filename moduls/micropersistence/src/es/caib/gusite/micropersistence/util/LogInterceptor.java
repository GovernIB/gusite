...
public class LogInterceptor implements MethodInterceptor, Serializable {
	...
	private Object afterReturn(Object obj, Method method, Object[] params,
			boolean b, Object result, Throwable excepcion) throws Throwable {
		if (excepcion != null) {
		...
		if (result != null) {
			if (result instanceof Collection<?>) {
				logText += " (" + ((Collection<?>) result).size() + ") "
						+ result;
			} else if (result.getClass().isArray()) {
				Object[] objects = (Object[]) result;
				logText += " (" + objects.length + ") "
						+ Arrays.asList(objects);
			} else {
				logText += result;
			}
		}
		this.getLog().info(logText);
		return result;
	}
	...
	public Object intercept(Object obj, Method method, Object[] params,
		...
		boolean llamarSuper = this.invokeSuper(obj, method, params);
		Object result = null;
		...
		return this.afterReturn(obj, method, params, llamarSuper, result,
				exception);
	}
