...
public class FrancesAnalyzer extends Analyzer {
    ...
    protected static final String[] STOP_WORDS = {
    	...
    	"de", "la", "que", "le", "en", "et", "ï¿½", "les", "du", "se", "pour", "par" , "un", "avec", "non", 
    	"une", "la sienne", "leur", "au", "il", "elle est", "le", "comme", "plus", "cependant",
    	"les siennes", "leurs", "lui", "dï¿½jï¿½", "ou", "elle est allï¿½", "celui ci", "a",
    	"oui", "parce que", "celle ci", "ils", "elles sont", "entre", "quand", 
    	"beaucoup", "sans", "sur", "ï¿½tre", "elle a", "aussi", "me", "jusqu'ï¿½", "il y a", "oï¿½", "ont", "qui", "ï¿½tat", 
    	"depuis", "tout", "organisme", "pendant", "ï¿½tats", "tous", "un", "mï¿½me pas", "contre", "quelques autres", "elles sont allï¿½s",
    	"avait", "devant", "eux", "ceci", "moi", "avant", "quoi", "quelques uns", "un autre", "une autre", "tant", "pas du tout",
    	"peu", "elle", "avoir", "elle ï¿½tait", "quelques unes", "quelque chose",
		"le mien", "les miens", "toi", "te", "le tien", "les tiens", "elles", "nous", "vous", "ï¿½ moi", "ï¿½ toi", "siï¿½ge", "ï¿½ lui", "elle",
		"siï¿½ges", "elle","elles", "ï¿½ nous", "ï¿½ vous", "ceux ci", "celles ci", "tu es", 
		"nous sommes", "vous ï¿½tes", "soyez", "tu sois", "nous soyons", "elle sera", 
		"vous serez", "elles seront","elle serait", "elles seraient", "elles ï¿½taient",
		"j'ai ï¿½tï¿½", "tu as ï¿½tï¿½", "elle a ï¿½tï¿½", "nous avons ï¿½tï¿½", "lancez ï¿½tre", "elles ont ï¿½tï¿½",
		"vous soyez","elles soient", "elle soit","sï¿½jour", "sï¿½jours","ai", "as", "a", "avons", "avez", "ont", "ait", "aies", 
        ...
        "je serai", "tu seras", "nous serons", "tu serais", "nous serions", "vous seriez","tu ï¿½tais", "nous ï¿½tions", "vous ï¿½tiez",
        "je suis allï¿½", "tu es allï¿½", "nous sommes allï¿½s", "lancez aller","dehors", "nous aillions", "elles aillent","elle aille", "tu ailles",
		"vous ailliez", "sentant", "entendue", "sens", "entendues", "ï¿½tant", "sentez", "j'ai", "tendu", "nous avons", "vous avez",
