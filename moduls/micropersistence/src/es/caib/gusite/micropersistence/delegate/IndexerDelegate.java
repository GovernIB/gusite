...
public class IndexerDelegate implements StatelessDelegate {
	 ...
	 */
	public synchronized void insertaObjeto(IndexObject indexObject,
			String idioma, IndexWriter writer) throws DelegateException {
		try {
			this.local.insertaObjeto(indexObject, idioma, writer);
	 ...
	 * @throws DelegateException
	 */
	public synchronized void borrarObjeto(String id, String idi)
			throws DelegateException {
		try {
			this.local.borrarObjeto(id, idi);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	 ...
	 * @throws DelegateException
	 */
	public synchronized void indexarObjeto(Object objeto)
			throws DelegateException {
		try {
			this.local.indexarObjeto(objeto);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	 ...
	 * @throws DelegateException
	 */
	public synchronized void desindexarObjeto(Object objeto)
			throws DelegateException {
		try {
			this.local.desindexarObjeto(objeto);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	 ...
	 * @throws DelegateException
	 */
	public synchronized void confeccionaDiccionario(String idi)
			throws DelegateException {
		try {
			this.local.confeccionaDiccionario(idi);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	...
	public void desindexarMicrosite(Long idsite) throws DelegateException {
		try {
			this.local.desindexarMicrosite(idsite);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	 ...
	 * @throws DelegateException
	 */
	public IndexResultados buscar(String micro, String idi, String idlista,
			String cadena, boolean sugerir) throws DelegateException {
		try {
			return this.local.buscar(micro, idi, idlista, cadena, sugerir);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	 ...
	 * @throws DelegateException
	 */
	public synchronized ArrayList<?> diccionario(String idi)
			throws DelegateException {
		try {
			return this.local.diccionario(idi);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	 ...
	 */
	public synchronized void reindexarMicrosite(Long idsite)
			throws DelegateException {
		try {
	...
	public void setBloqueado(boolean bloqueado) throws DelegateException {
		try {
			this.local.setBloqueado(bloqueado);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
	...
	public Directory getHibernateDirectory(String idi) throws DelegateException {
		try {
			return this.local.getHibernateDirectory(idi);
		} catch (EJBException e) {
			throw new DelegateException(e);
		}
	}
