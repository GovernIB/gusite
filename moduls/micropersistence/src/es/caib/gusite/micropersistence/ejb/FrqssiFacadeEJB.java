...
public abstract class FrqssiFacadeEJB extends HibernateEJB {
    ...
    public void init(Long site) {
    	...
    	super.where = " where trad.id.codigoIdioma = '" + Idioma.getIdiomaPorDefecto() + "' and frqssi.idmicrosite = " + site.toString();
    	super.whereini = " ";
    	super.orderby = "";
    ...
    public void init(Long site, String idiomapasado) {
    	...
    	super.from = " from Frqssi frqssi join frqssi.traducciones trad ";
    	super.where = " where (trad.id.codigoIdioma = '" + Idioma.getIdiomaPorDefecto() + "' or trad.id.codigoIdioma = '" + idiomapasado + "') and frqssi.idmicrosite = " + site.toString();
    	super.whereini = " ";
    ...
    public Long grabarFrqssi(Frqssi frqssi) throws DelegateException {
        ...
        try {
            ...
            if (nuevo) {
                Iterator<TraduccionFrqssi> it = frqssi.getTraducciones().values().iterator();
                while (it.hasNext()) {
