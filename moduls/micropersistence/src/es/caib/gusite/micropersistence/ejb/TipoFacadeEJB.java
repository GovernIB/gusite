...
public abstract class TipoFacadeEJB extends HibernateEJB {
    ...
    public void init(Long site) {
    	...
    	super.where = " where trad.id.codigoIdioma = '" + Idioma.getIdiomaPorDefecto() + "' and tipo.idmicrosite = " + site.toString();
    	super.whereini = " ";
    	super.orderby = "";
    ...
    public void init(Long site,String idiomapasado) {
    	...
    	super.from = " from Tipo tipo join tipo.traducciones trad ";
    	super.where = " where (trad.id.codigoIdioma = '" + Idioma.getIdiomaPorDefecto() + "' or trad.id.codigoIdioma = '" + idiomapasado + "') and tipo.idmicrosite = " + site.toString();
    	super.whereini = " ";
    	super.orderby = "";
    ...
    public Long grabarTipo(Tipo tipo) {
        ...
        try {
            ...
            if (nuevo) {
                Iterator<TraduccionTipo> it = tipo.getTraducciones().values().iterator();
                while (it.hasNext()) {
    ...
    public boolean checkSite(Long site, Long id) {
        ...
        Session session = getSession();
        try {
        	Query query = session.createQuery("select tipo from Tipo tipo where tipo.idmicrosite = " + site.toString() + " and tipo.id = " + id.toString());
