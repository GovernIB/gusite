...
import org.ibit.rol.sac.micropersistence.util.NoticiaFacadeUtil;
import org.ibit.rol.sac.micropersistence.intf.NoticiaFacade;
import org.ibit.rol.sac.micropersistence.intf.NoticiaFacadeHome;
...
public class NoticiaDelegate implements StatelessDelegate, NoticiaServiceItf {
	 ...
	 */
    public List<?> listarNoticiasThin(String idioma) throws DelegateException {
        try {
    ...
    public List<String> listarAnyos() throws DelegateException, HibernateException {
    	try {
