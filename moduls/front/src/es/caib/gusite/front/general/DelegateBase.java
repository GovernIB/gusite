...
public class DelegateBase {
	 ...
	 * @throws Exception
	 */
	public ArrayList<?> obtenerMainMenu(Long idmicrosite, String idioma) throws DelegateException  {
	...
	public Contenido obtenerContenido(Long idcontenido, String idioma, Microsite microsite) throws ExceptionFrontPagina  {
		try {
			...
			throw new ExceptionFrontPagina(" [obtenerContenido, idsite=" + microsite.getId() + ", cont=" + idcontenido + ", idioma=" + idioma + " ] Error=" + e.getMessage() + "\n Stack=" + Cadenas.statcktrace2String(e.getStackTrace(), 3) );
		}
...
/* ****************      METODOS   PRIVADOS          ******************* */
	 ...
	 * @return ArrayList
	 */
	private ArrayList<MenuFront> montarmenu(Long idmicrosite, String idi) throws DelegateException {
		...
		//los menus de primer nivel ya salen ordenados
		    ...
		    while (iter.hasNext()) {
			    ...
			    while (iterpaginas.hasNext()) {
			    	...
			    	if (tracon==null) { iditmp=Idioma.getIdiomaPorDefecto(); tracon = (TraduccionContenido)conte.getTraduccion(iditmp); }
			    ...
			    while (itermenus.hasNext()) {
				    ...
				    while (iterpaginassub.hasNext()) {
				    	...
				    	if (tracon==null) { iditmp=Idioma.getIdiomaPorDefecto(); tracon = (TraduccionContenido)contesub.getTraduccion(iditmp); }
				    	if ( (tracon!=null) && (tracon.getTitulo()!=null) ){
