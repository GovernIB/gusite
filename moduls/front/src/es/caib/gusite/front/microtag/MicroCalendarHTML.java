...
/**
 * Clase MicroCalendar. Monta el código HTML para montar el calendario que se
 * mostrará en los Microsites.
 * 
 * @author pmelia
 * 
 */
public class MicroCalendarHTML {
	...
	/**
	 * Método público que devuelve el evento del calendario, HEAD, TH(tag HTML
	 * th define una celda en una tabla) y Contenido
	 * 
	 * @param idsite
	 * @param anyo
	 * @param mes
	...
	private static String getTableCalendarHead(int anyo, int mes, String idioma) {
		...
		switch (mes) {
		case 1:
			retorno += rb.getString("calendario.enero");
			break;
		case 2:
			retorno += rb.getString("calendario.febrero");
			break;
		case 3:
			retorno += rb.getString("calendario.marzo");
			break;
		case 4:
			retorno += rb.getString("calendario.abril");
			break;
		case 5:
			retorno += rb.getString("calendario.mayo");
			break;
		case 6:
			retorno += rb.getString("calendario.junio");
			break;
		case 7:
			retorno += rb.getString("calendario.julio");
			break;
		case 8:
			retorno += rb.getString("calendario.agosto");
			break;
		case 9:
			retorno += rb.getString("calendario.septiembre");
			break;
		case 10:
			retorno += rb.getString("calendario.octubre");
			break;
		case 11:
			retorno += rb.getString("calendario.noviembre");
			break;
		case 12:
			retorno += rb.getString("calendario.diciembre");
			break;
		}
		retorno += " " + anyo;
		retorno += "</caption>";
	...
	/**
	 * Método privado que devuelve el contenido del calendario para un site, un
