...
public class MParserComponente extends MParserHTML {
	...
	private StringBuffer getHtmlComponenteTDocumento(Long idmicrosite, Componente componente, String idioma) {
		...
		try {
	    	...
	    	noticiadel.init();noticiadel.setPagina(1);noticiadel.setTampagina(componente.getNumelementos().intValue());
	    	java.sql.Date dt = new java.sql.Date((new Date()).getTime());
	    	String wherenoticias="where trad.id.codigoIdioma='" + idioma + "' and noti.visible='S' and noti.idmicrosite=" + idmicrosite + " and noti.tipo=" + componente.getTipo().getId().toString();
	    	wherenoticias+=" and (noti.fpublicacion is null OR to_char(noti.fpublicacion,'yyyy-MM-dd')<='" + dt + "')";
	    	wherenoticias+=" and (noti.fcaducidad is null OR to_char(noti.fcaducidad,'yyyy-MM-dd')>='" + dt + "')";
	    	noticiadel.setWhere(wherenoticias);
	    	noticiadel.setOrderby2(preparaOrden(componente.getOrdenacion().toString()));
	...
	<div id="noticies">
		<h2>Notícies</h2>
		<!-- El class per a un enllaç intern es 'enlaceInterno' -->
		<ul>
			<li><img src="imgs/noticies/news.gif" alt="" />
				07/02/2007 - <span class="font">Computing</span>
				<span class="enllas">La Comunitat Autónoma de les Illes Balears compleix en administració electrónica</span>
				<span class="enllas"><a href="noticias/Noticia_20070207_CP.pdf" class="docPDF">Descarregar notícia en format PDF de 352 kb</a></span>
			</li>
			<li><img src="imgs/noticies/news.gif" alt="" />
				31/01/2007 - <span class="font">Europa Press</span>
				<span class="enllas"><a href="http://www.europapress.es/noticia.aspx?cod=20070131121003&ch=239" class="enlaceExterno">El conseller d'Economia, Hisenda i Innovació, Lluís Ramis de Ayreflor, presenta els últims avanços en la implantació i desenvolupament del Pla d'Administració Digital de Balears</a></span>
				<span class="enllas"><a href="noticias/Noticia_20070131_EP.pdf" class="docPDF">Descarregar notícia en format PDF de 67 kb</a></span>
			</li>
			<li><img src="imgs/noticies/news.gif" alt="" />
				18/01/2007 - <span class="font">Diario de Mallorca</span>
				<span class="enllas"><a href="http://www.diariodemallorca.es/secciones/noticia.jsp?pNumEjemplar=1415&pIdSeccion=903&pIdNoticia=236821&rand=1169120257342" class="enlaceExterno">El Govern telematitzará els 80 procedimients administratius más demandats pels usuaris</a></span>
				<span class="enllas"><a href="noticias/Noticia_20070118_DMall.pdf" class="docPDF">Descarregar notícia en format PDF de 79 kb</a></span>
			</li>
		</ul>
