...
public class LegacyController extends FrontController {
	 ...
	 * Con el tiempo, podemos estudiar los logs para sustituir estos requests.
	 * 
	 */
	...
	public String contenidoRelativo (
		...
		return contenido(idSite, lang, idContenido, model, pcampa);		
	}
	 ...
	 * contenido.do?idsite=449&cont=15812&lang=ca&campa=yes
	 * z
	 */
	...
	public String contenidoRelativo (
		...
		return contenido(mkey, lang, idContenido, model, pcampa);	
	}
	...
	public String contenido (
		...
		Microsite microsite = null;
	  	try {
			...
			return contenido(microsite.getId(), lang, idContenido, model, pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * contacto.do?mkey=M94&lang=es&cont=213
	 * z
	 * @throws DelegateException 
	 */
	...
	public String contacto (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return contacto(microsite.getId(), lang, idContacto, model, pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * noticia.do?mkey=M11050411433211050557&lang=ca&cont=31549
	 * z
	 * @throws DelegateException 
	 */
	...
	public String noticia (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return noticia(microsite.getId(), lang, idNoticia, model, pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * noticias.do?mkey=M10101513200930602688&lang=ca&tipo=3306
	 * z
	 * @throws DelegateException 
	 */
	...
	/**
	 * Urls de contenido antiguo. 
	 * noticias.do?mkey=M10101513200930602688&lang=ca&tipo=3306&tanyo=2010
	 * z
	 * @throws DelegateException 
	 */
	...
	/**
	 * Urls de contenido antiguo. 
	 * noticias.do?mkey=M10101513200930602688&lang=ca&cont=3306&tanyo=2010
	 * z
	 * @throws DelegateException 
	 */
	...
	/**
	 * Urls de contenido antiguo. 
	 * qssi.do?[sitelang]&cont=formQssi
	 * z
	 * @throws DelegateException 
	...
	public String qssi (
					...
					Model model,
					@RequestParam(value=Microfront.PCAMPA, required = false, defaultValue="") String pcampa) throws DelegateException, ExceptionFrontPagina {
	...
	public String qssi (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return qssi(microsite.getId(), lang, idQssi, model, pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * elementodocumento.do?mkey=M60&cont=16707&lang=CA
	 * z
	 * @throws DelegateException 
	 * @throws ExceptionFrontPagina 
	 */
	...
	public String elementodocumento (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return elementodocumento(microsite.getId(), lang, idDocumento, model, pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * agenda.do?mkey=M7&lang=ca&cont=20131122
	 * z
	 * @throws DelegateException 
	 */
	...
	public String agenda (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return agenda(microsite.getId(), lang,idAgenda, model,pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * agendas.do?mkey=M09112511445915080171&lang=ca
	 * z
	 * @throws DelegateException 
	 */
	...
	public String agendas (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return agendas(microsite.getId(), lang, model,pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * encuesta.do?mkey=M11010412302126072344&lang=ca&cont=769
	 * z
	 * @throws DelegateException 
	 */
	...
	public String encuesta (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return encuesta(microsite.getId(), lang, idEncuesta, model, pcampa);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	public String index (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return index(microsite.getId(),lang,model);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	public String mapa (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return mapa(microsite.getId(),lang,model);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	/**
	 * Urls de contenido antiguo. 
	 * accessibilitat.do?idsite=1244&lang=CA
	 * z
	 * @throws DelegateException 
	 */
	...
	public String accessibilitat (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return accessibilitat(microsite.getId(),lang,model);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	public String faqs (
		...
		Microsite microsite = null;
	  	try {
			microsite =  this.dataService.getMicrositeByKey(mkey, lang);
			return faqs(microsite.getId(),lang,model);
        } catch (ExceptionFrontMicro e) {
        	log.error(e.getMessage());
        	//TODO: 404?
        	return getForwardError (microsite, lang, model, ErrorMicrosite.ERROR_AMBIT_MICRO);
	...
	public String archivopubRelativo (
					@PathVariable("mkey") SiteId prevSiteId, 
					@PathVariable("lang") Idioma prevLang,
					@PathVariable("tipo") char tipo,
					@PathVariable("tipoId") String tipoId,
		...
		return archivopub(ctrl, id, model);
	...
	public String archivopub (
					@RequestParam(Microfront.PCTRL) String ctrl, 
	...
	public String archivopubPorNombre (
					...
					@RequestParam(value=Microfront.PIDSITE) Long idSite,
					Model model) {
