...
public class ContenidoDataService {
	...
	public Contenido getContenido(Microsite microsite, String uriContenido, String lang) throws ExceptionFrontPagina {
		...
		try {
			...
			TraduccionContenido traduccionContenido = ((TraduccionContenido) contenido.getTraduccion(lang));
