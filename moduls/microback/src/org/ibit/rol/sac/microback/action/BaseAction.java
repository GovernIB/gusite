...
/**
 * Action Base con m�todos de utilidad de la que heredan las dem�s Acciones 
 */
public abstract class BaseAction extends Action {
	...
	/**
	 * 
	 * M�todo que genera un Archivo a partir de un Formfile
	 * 
	 * @param archivo
	 * @param formFile
	 * @param microsite
    ...
    /**
     * M�todo que genera un FormFile a partir de un Archivo
     * 
     * @param archivo
     * @param formFile
     * @return
    ...
    /**
     * M�todo que crear un nuevo archivo en una p�gina de Microsite
     * @param archivo
     * @param microsite
     * @param pagina
     * @return
