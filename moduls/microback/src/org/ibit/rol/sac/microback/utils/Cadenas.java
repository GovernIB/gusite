...
public class Cadenas {
	...
	/**
	 * Mï¿½todo que divide el string en palabras y las pasa a un hashtable
	 * 
	 * @param cadena
	 * @return Hashtable
	 */
	...
	/**
	 * Mï¿½todo que dada una URI devuelve el valor de un parametro.
	 * 
	 * @param cadena
	...
	/**
	 * Mï¿½todo que parsea substituyendo los saltos de linea por tags BR
	 * 
	 * @param lineas
	 * @return String
	 */
	...
	/**
	 * Mï¿½todo que cuenta el nï¿½mero de veces que aparece un substring en un
	 * string
	 * 
	 * @param frase
	 *            string
