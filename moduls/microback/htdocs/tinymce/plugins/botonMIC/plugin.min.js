			...
			a.windowManager.open({
				...
				buttons: [{
					...
					onclick: function( e ) {
						...
						if (elementoSeleccionado == null) {
							alert("No hi ha botó seleccionat per esborrar.");
						} else {
                ...
                onsubmit: function(b) {
					...
					if (elementoSeleccionado == null) {
						...
						//Seteamos el href
						if (b.data.url != null && b.data.url != '') {
							tinymce.activeEditor.dom.setAttrib(elementoSeleccionado, 'href',  b.data.url);
						} else {
							tinymce.activeEditor.dom.setAttrib(elementoSeleccionado, 'href',  '');
						}
						
						
						if (b.data.icono != null && b.data.icono != '') {
							tinymce.activeEditor.dom.setAttrib(elementoSeleccionado, 'style',  'background-image: url('+b.data.icono+')');
						} else {
							tinymce.activeEditor.dom.setAttrib(elementoSeleccionado, 'style',  '');							
						}					
