		...
		init : function(ed, url) {
			...
			ed.addCommand('mceTipoarchivos', function() {
				ed.windowManager.open({
					file : '/sacmicroback/tinymce/plugins/tipoarchivos/tipoarchivos.htm',
					width : 260 + parseInt(ed.getLang('tipoarchivos.delta_width', 0)),
					height : 260 + parseInt(ed.getLang('tipoarchivos.delta_height', 0)),
					inline : 1
				}, { 
					plugin_url : url
				});
