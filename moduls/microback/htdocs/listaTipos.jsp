...
<body>
	...
	<bean:message key="menu.listados" />. <span><bean:message key="tipo.configuracion" /></span></h1>
...
<!-- HAY algun componente -->
		...
		<p><bean:message key="tipo.dobleclic" />.</p>
				...
				<tr>
					<td colspan="5">
				        ...
				        <logic:present name="parametros_pagina" property="inicio">
				            &lt;&lt;<html:link action="/tipos.do?" paramId="pagina" paramName="parametros_pagina" paramProperty="inicio"><bean:message key="op.7" /></html:link>&nbsp;&nbsp;
				        </logic:present>
				        <logic:present name="parametros_pagina" property="anterior">
				            &lt;<html:link action="/tipos.do" paramId="pagina" paramName="parametros_pagina" paramProperty="anterior"><bean:message key="op.8" /></html:link>&nbsp;&nbsp;      
				        </logic:present>
				        ...
				        <logic:present name="parametros_pagina" property="siguiente">
				            <html:link action="/tipos.do" paramId="pagina" paramName="parametros_pagina" paramProperty="siguiente"><bean:message key="op.9" /></html:link>&gt;&nbsp;&nbsp;      
				        </logic:present>
				        <logic:present name="parametros_pagina" property="final">
				            <html:link action="/tipos.do" paramId="pagina" paramName="parametros_pagina" paramProperty="final"><bean:message key="op.10" /></html:link>&gt;&gt;&nbsp;&nbsp;      
				        </logic:present>
...
var uriEdicion="tipoEdita.do?id=";
