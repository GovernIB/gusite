package org.ibit.rol.sac.microfront.faq.util;
...
import org.ibit.rol.sac.microfront.faq.bean.Faqtema;
...
public class Bdlistafaqs extends Bdbase {
	...
	private void prepararlistado() throws Exception {
		...
		temadel.setWhere("where index(trad)='" + idioma + "' and tema.idmicrosite=" + super.idsite);
		...
		while (iter.hasNext()) {
		    	...
		    	faqdel.setWhere("where index(trad)='" + idioma + "' and faq.visible='S' and faq.tema=" + tema.getId());
