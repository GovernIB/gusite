...
public class BdEnvioencuesta  extends Bdbase {
	 ...
	 *  graba la informaci�n de la encuesta y la recoge (con los resultados) para enviarla al usuario.
	 * @param request
	 * @throws Exception
	 */
	...
	/**
	 *  M�todo privado que procesa la sesi�n. Averigua si el usuario ha rellenado la encuesta en sesi�n.
	 */
	...
	/**
	 * M�todo privado. 	
	 * El formulario no lo tenemos en ninguna clase 'form', as� que
	...
	private void procesaformulario() throws Exception {
		...
		if (es.caib.utilities.date.Fechas.vigente(encuesta.getFpublicacion(), encuesta.getFcaducidad())) {
			    ...
			    upm.setIdusuario(encu.grabarUsuarioEncuesta(usuario));
			    ...
			    while (paramNames.hasMoreElements())  {
				      ...
				      if (!paramName.equals(Microfront.PLANG) && !paramName.equals(Microfront.PIDSITE)
				    	  ...
				    	  if (paramName.charAt(0)=='T') {
								...
								resdat.setIdusuari(upm.getIdusuario());
							    ...
							    if (paramValues.length == 1) {
							        ...
							        if (paramValue.length() == 0) {
									    ...
									    upm.setIdrespuesta(new Long(paramValue));
							        ...
							        for (int i=0; i < paramValues.length; i++) {
							        	...
							        	upm.setIdrespuesta(new Long(paramValues[i]));
									    encuestadel.grabarUsuarioPropietarioRespuesta(upm);
							        }
							        cuerpomensaje+="\n";
						      }
