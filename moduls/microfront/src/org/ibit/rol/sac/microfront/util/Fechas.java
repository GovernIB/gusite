package org.ibit.rol.sac.microfront.util;
 ...
 *
 */
public class Fechas extends es.caib.utilities.date.Fechas {
		...
		public static boolean betweenHours(Date fechaacomparar, int horaInicio, int minutosInicio, int horaFin, int minutosFin) {
			...
			if (fechaacomparar==null) return false;
	  ...
	  /**
		 * Calcula si 'algo' está caducado respecto a la fecha actual.
		 * método que devuelve true o false en función de la fecha de caducidad que se le
		 * pasa por parametro.
		 * 
		 * @sobrecarga de método.<br/>
		 * 
		...
		public static boolean caducada(Date fechaCaducidad) {
		  ...
		  /**
		 * Calcula si 'algo' está postergado respecto a la fecha actual.
		 * método que devuelve true o false en función de la fecha de entrada que se le
		 * pasa por parametro.
		 * 
		 * @sobrecarga de método.<br/>
		 * 
