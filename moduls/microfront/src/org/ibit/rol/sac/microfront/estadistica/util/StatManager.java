...
public class StatManager {
	...
	/**
	 * Método público para grabar las estadísticas del componente Lista de distribución.
	...
	/**
	 * Método público para grabar las estadísticas del componente Banner.
	 * 
	 * @param banner
	 * @param publico
	 * @param buffer
	...
	/**
	 * 
	 * Método público para grabar las estadísticas el acceso a un Microsite. Con el tipo de servicio RFAQ = "FQS00"
	 * @param idmicrosite
	 * @param publico
	 * @param buffer
	 * @return List
	...
	/**
	 * Método público para grabar las estadísticas el acceso a un Microsite. En función de un tipo de servicio.
	 * @param idmicrosite
	 * @param tipo
	 * @param publico
	 * @param buffer
	...
	/**
	 * Método privado al que llaman el resto. Es el encargado de sumar y grabar la estadistica
	 * @param idmicrosite
	 * @param iditem
	 * @param ref
	 * @throws DelegateException
	...
	private static List<Estadistica> grabarStat(Long idmicrosite, Long iditem, String ref, int publico, List<Estadistica> buffer) throws DelegateException  {
		...
		// La grabación de estadísticas no se realiza en el rango de horas de 1 a 2 para evitar
		...
		if (!Fechas.betweenHours(new Date(), 1, 0, 2, 0)) { 
			...
			//Tratamos el buffer en el caso que tenga estadísticas y las grabamos en BBDD
