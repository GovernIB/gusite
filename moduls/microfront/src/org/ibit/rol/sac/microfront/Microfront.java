...
/**
 * Clase b�sica de los microsites. 
...
public class Microfront {
	...
	static public final String PCAMPA = "campa"; //elemento de campa�a
	...
	static public final String PSTAT = "stat"; //parametro que servir� para indicar que no se hagan estad�sticas en la sesion
	static public final String PNAME = "name"; //parametro que servir� para recoger una imagen por nombre
	static public final String PENCCOMP = "enccomp"; //parametro que indicar� que se est� contestando una encuesta de un componente
	static public final String PVIEW = "view"; //indicar� que solo visualizaremos resultados
	static public final String PMKEY = "mkey"; //iddentificador unico de microsite
	static public final String PEMAIL = "email"; //parametro que servir� para recoger ek email
	static public final String PACTION = "accio"; //parametro que servir� para indicar la operacion a realizar
