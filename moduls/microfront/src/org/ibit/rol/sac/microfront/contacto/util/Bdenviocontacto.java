...
public class Bdenviocontacto extends Bdbase   {
	 ...
	 * Lo recorreremos y lo iremos empaquetando en un string que ser� el 
	 * cuerpo del mensaje a enviar por correo. 
	 * Adem�s en sesi�n tenemos la variable MVS_listparamform, que contiene
	...
	/**
	 * M�todo privado que se encarga de enviar via correo electr�nico la informaci�n del formulario
	 * @throws Exception
	 */
