...
/**
 * Manejador de la petición de formulario de contacto.
 * 
 * Mete en una lista el bean pardato.
 * En ese bean mete el texto y el tag html que se emplearán en el JSP.
 * <BR>
 * Además meterá en una variable de sesión una hashtable con la misma lista.
 ...
 * La variable en sesión es MVS_listparamform. 
 * 
 * @author Indra
 */
...
public class Bdcontacto extends Bdbase  {
	...
	/**
	 * Métdo privado para recoger el contacto
	 * @throws Exception 
	 */
