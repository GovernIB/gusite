									...
									<logic:notEqual name="MVS_parametros_pagina" property="nreg" value="0">  
												...
												<logic:notEmpty name="i" property="traduce.titulo">
													<li style="list-style: none;">
														...
														<a href="elementodocumento.do?idsite=<bean:write name="i" property="idmicrosite" />&amp;cont=<bean:write name="i" property="id" />&amp;lang=<bean:write name="MVS_idioma" />" target="_blank"><bean:write name="i" property="traduce.titulo" ignore="true"/></a>
