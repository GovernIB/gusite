...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%>
			...
			<logic:present name="MVS_microsite">
				...
				<logic:equal name="tipocabecera" value="1">
						...
						<ul id="serveis">
							<li><a href="/portaldelciutada/serveis.do?lang=<%=((String)request.getSession().getAttribute("MVS_idioma")).toLowerCase() %>"><bean:message key="WEB2_GEN003"/></a>
								<ul>
									<li><a href="/portaldelciutada/infotramits.do?lang=<%=((String)request.getSession().getAttribute("MVS_idioma")).toLowerCase() %>" class="destacat important"><bean:message key="WEB_CIU002" /></a></li>
									<li><a href="/portaldelciutada/infoajutsbeques.do?lang=<%=((String)request.getSession().getAttribute("MVS_idioma")).toLowerCase() %>" class="destacat"><bean:message key="WEB_CIU028" /></a></li>					
									<li><a href="<bean:message key="WEB2_SEULINK"/>"><bean:message key="WEB2_SEU" /></a></li>
									<li><a href="<bean:message key="WEB2_CONGENERAL" />"><bean:message key="WEB2_CONTRATACIO" /></a></li>					
									<li><a href="<bean:message key="WEB_CIU064" />"><bean:message key="WEB2_TEM102" /></a></li>
									<li><a href="<bean:message key="WEB2_GEN137"/>"><bean:message key="WEB2_GEN138" /></a></li>
									<li><a href="<bean:message key="WEB2_GEN140" />"><bean:message key="WEB2_GEN139" /></a></li>
									<li><a href="/sacmicrofront/contenido.do?mkey=M08082109010018816268&amp;lang=<%=((String)request.getSession().getAttribute("MVS_idioma")).toLowerCase() %>&amp;cont=8673"><bean:message key="WEB_MOD041"/></a></li>
								</ul>
							</li>
							<li>-<a href="/govern/index.do?lang=<%=((String)request.getSession().getAttribute("MVS_idioma")).toLowerCase() %>"><bean:message key="WEB_CIU003"/></a>
								<ul>
									...
									<logic:iterate id="i" name="MVS2_uos">
										<logic:notEqual name="i" property="codi" value="2">						
											<li>&nbsp;-&nbsp;<a href="/govern/organigrama/area.do?lang=<%=((String)request.getSession().getAttribute("MVS_idioma")).toLowerCase() %>&amp;coduo=<bean:write name="i" property="codi"/>"><bean:write name="i" property="abreviatura"/></a></li>
										</logic:notEqual>
									</logic:iterate>
									</logic:present>
							...
							<li>-<a href="/boib/index.do?lang=<%=((String)request.getSession().getAttribute("MVS_idioma")).toLowerCase() %>"><bean:message key="WEB_CER020"/></a>
							</li>				
