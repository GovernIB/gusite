												...
												<logic:iterate name="MVS_agenda_lista" id="i">
													...
													<bean:write name="i" property="finicio" format=" dd/MM/yyyy"/>
													 <bean:define id="horai">
														...
														<br />
														<a href="agenda.do?mkey=<bean:write name="MVS_microsite" property="claveunica"/>&amp;cont=<bean:write name="i" property="finicio" format="yyyyMMdd"/>&amp;lang=<bean:write name="MVS_idioma" />"><bean:write name="i" property="traduce.titulo" ignore="true"/></a>
													</li>
												</logic:iterate>
												</ul>
