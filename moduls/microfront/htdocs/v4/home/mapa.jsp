									    	...
									    	<logic:iterate name="i" id="j" property="listacosas">
										    	<ul>
												   <bean:define id="objeto" name="j" type="Object"/>
											   		<%
											    	if (objeto instanceof org.ibit.rol.sac.micromodel.Contenido) {
											    	%>
											    		<li><a href="contenido.do?mkey=<bean:write name="MVS_microsite" property="claveunica"/>&amp;lang=<bean:write name="MVS_idioma"/>&amp;cont=<bean:write name="j" property="id"/>"><bean:write name="j" property="traduce.titulo"/></a></li>
											    	<%
											    	} else {
											    	%>	
												    	...
												    	<logic:notEqual name="tamano" value="1">
													    	<li><bean:write name="j" property="traduce.nombre"/>
																...
																<logic:iterate name="j" id="k" property="listacosas">
																			<li><a href="contenido.do?mkey=<bean:write name="MVS_microsite" property="claveunica"/>&amp;lang=<bean:write name="MVS_idioma"/>&amp;cont=<bean:write name="k" property="id"/>"><bean:write name="k" property="traduce.titulo"/></a></li>
																</logic:iterate>
																</ul>
															</li>
												    	</logic:notEqual>
												    	...
												    	<logic:equal name="tamano" value="1">
															<li><a href="contenido.do?mkey=<bean:write name="MVS_microsite" property="claveunica"/>&amp;lang=<bean:write name="MVS_idioma"/>&amp;cont=<bean:write name="j" property="listacosas[0].id"/>"><bean:write name="j" property="traduce.nombre"/></a></li>								    	
												    	</logic:equal>
											    	<%
											    	}
											   		%>
