...
<head>
  ...
  <META http-equiv="refresh" content="1; URL=<%= request.getContextPath() %>/intranet/home.do?mkey=<bean:write name="MVS_microsite" property="claveunica"/>&amp;lang=<bean:write name="MVS_idioma" />">
