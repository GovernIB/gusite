...
/**
 * Clase Archivo. Bean que define una Archivo. Modela la tabla de BBDD GUS_DOCUS sin el BLOB.
 * 
 * @author Indra
 */
...
public class ArchivoLite extends AuditableModel implements Indexable {
